...
#define WFW_CMD_GET_FRAME_SECURE              0x98
...
/****************************************************************************
 * WFW_CMD_GET_FRAME_SECURE
 ****************************************************************************/

/* The command: */
typedef struct WFW_PACKED wfw_cmd_get_frame_secure_s
{
  wfwUint8_t          random[8];  /* 64-bit random value generated by host */
} wfw_cmd_get_frame_secure_t;

/* The reply: */
typedef struct WFW_PACKED wfw_reply_get_frame_secure_s {
  wfwUint8_t          random[8];  /* 64-bit random value generated by sensor */
  wfwUint8_t          iv[12];     /* 96-bit AES-GCM initialization vector */
  wfwUint8_t          at[16];     /* 128-bit AES-GCM authentication tag */
  wfwUint16_t         nrows;      /* number of rows of pixels per frame */
  wfwUint16_t         ncols;      /* number of columns of pixels per frame */
  wfwUint16_t         bitdepth;   /* number of bits per pixel (16, 12, etc) */
} wfw_reply_get_frame_secure_t;
...
// DEPRECATED #define WFW_IOTA_ITYPE_FRAME_BASE         0x0001
 ...
 * and WOF_DM are applied; when entering imaging mode, BASE_REG
 ...
 * finger scanning.  Similarly, IMAGE_DM are the
 * drive-matrix for fingerprint (full-image) scanning, and NAV_REG and
...
// DEPRECATED #define WFW_IOTA_ITYPE_IMAGE_REG          0x0006
