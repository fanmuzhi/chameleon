...
/*!
\b Problem:  \n Optical sensor is seen in Sunlight. Please tell user to put phone in shade \n
*/
#define VCS_IMAGE_QUALITY_SENSOR_IN_SUNLIGHT               ((vcsImageQuality_t) 0x00000100)
...
/*!
\b Problem: LOW_LIVE_MEAN_POSSIBLY_HBM_OFF \n
\b This LOW_LIVE_MEAN_POSSIBLY_HBM_OFF replaces the obselete or unused VCS_IMAGE_QUALITY_EXCESSIVE_SPECKLE_NOISE_DETECTED
*/
#define VCS_IMAGE_QUALITY_LOW_LIVE_MEAN_POSSIBLY_LOW_BRIGHTNESS   ((vcsImageQuality_t) 0x00000400)
/*!
