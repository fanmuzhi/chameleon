...
static vector<test_step_db_t> TestStepDB = 
{
    ...
    // id                                           name                                arg_names,                                                                                                  args,                  args_desc       description
    {  TEST_STEP_ID_RAMTEST,                        "RAMTest",                          "",																											"",                    "",             "RAM test with patch"               },
    {  TEST_STEP_ID_ROMTEST,                        "ROMTest",                          "Type;Checksum",																							"1;0xE9",              "",			   "ROM test with patch"               },
	...
	{  TEST_STEP_ID_CPDARKBADPIXELTEST,				"CpDarkBadPixelTest",				"Coeff;MaxDarkIntBadPixels;MaxDarkLongIntBadPixels",														"2;1500;1500",		   "",			   ""								   },
