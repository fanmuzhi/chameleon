...
#define VCSFW_STATUS_ERR_FRAME_TAG_ORIENTPITCH_TOOSHORT                     \
                                                (VCSFW_STATUS_ERR_FLAG | 573)
#define VCSFW_STATUS_ERR_FRAME_TAG_ORIENTPITCH_TOOLONG                      \
                                                (VCSFW_STATUS_ERR_FLAG | 574)
#define VCSFW_STATUS_ERR_FRAME_TAG_IMGPROC_CROP_TOOSHORT                    \
                                                (VCSFW_STATUS_ERR_FLAG | 575)
#define VCSFW_STATUS_ERR_FRAME_TAG_IMGPROC_CROP_TOOLONG                     \
                                                (VCSFW_STATUS_ERR_FLAG | 576)
#define VCSFW_STATUS_ERR_FRAME_TAG_IMGPROC_DYNBPDET_TOOSHORT                \
                                                (VCSFW_STATUS_ERR_FLAG | 577)
#define VCSFW_STATUS_ERR_FRAME_TAG_IMGPROC_DYNBPDET_TOOLONG                 \
                                                (VCSFW_STATUS_ERR_FLAG | 578)
#define VCSFW_STATUS_ERR_FRAME_TAG_IMGPROC_3X3SEPSQ_TOOSHORT                \
                                                (VCSFW_STATUS_ERR_FLAG | 579)
#define VCSFW_STATUS_ERR_FRAME_TAG_IMGPROC_3X3SEPSQ_TOOLONG                 \
                                                (VCSFW_STATUS_ERR_FLAG | 580)
#define VCSFW_STATUS_ERR_FRAME_TAG_IMGPROC_DISABLE_TOOSHORT                 \
                                                (VCSFW_STATUS_ERR_FLAG | 581)
#define VCSFW_STATUS_ERR_FRAME_TAG_IMGPROC_DISABLE_TOOLONG                  \
                                                (VCSFW_STATUS_ERR_FLAG | 582)
#define VCSFW_STATUS_ERR_FRAME_TAG_IMGPROC_CROP_NO_MEMORY                   \
                                                (VCSFW_STATUS_ERR_FLAG | 583)
#define VCSFW_STATUS_ERR_FRAME_TAG_IMGPROC_3X3SEPSQ_NO_MEMORY               \
                                                (VCSFW_STATUS_ERR_FLAG | 584)
#define VCSFW_STATUS_ERR_FRAME_TAG_IMGPROC_DYNBPDET_NO_MEMORY               \
                                                (VCSFW_STATUS_ERR_FLAG | 585)
#define VCSFW_STATUS_ERR_ACQMODE_CONFLICT                                   \
                                                (VCSFW_STATUS_ERR_FLAG | 586)
#define VCSFW_STATUS_ERR_EVENT_NOT_SUPPORTED                                \
...
typedef struct VCS_PACKED vcsfw_event_s {
    ...
    union {
        ...
        struct {
            vcsUint32_t     nframes;  /* number of partial-frames to settle */
        } finger_settled;
    } details;
} vcsfw_event_t;
...
/* VCSFW_IOTA_ITYPE_FRAME_BUTTON is like the other FRAME_XXX iotas, in that it
 * is a collection of frame-tags to put the sensoe in button-scanning mode */
#define VCSFW_IOTA_ITYPE_FRAME_BUTTON   0x001C
/* An iota type for customer-specific data that has no defined structure
 * associated with it. The FW does not read this data, just MT, so it can
 * define whatever structure is needed to satisfy the customer need.
 */
 ...
 *  */
/* The values of "flags" (bit-field) field of vcsfw_config_woe_s struct */
...
typedef struct VCS_PACKED vcsfw_cal_image_mean_and_bad_pix_header_s {
    ...
    vcsUint8_t       misc[8];       /* misc[0] stores the compression / decompression algorithm version*/
