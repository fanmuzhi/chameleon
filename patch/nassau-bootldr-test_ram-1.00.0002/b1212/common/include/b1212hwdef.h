...
/*
 * Hayes (a/k/a B1212) family hardware definitions.
 *
 * Note that this does not contain individual register/field/enum definitions,
 *  which are auto-generated into b1212reg.h
 *
 *  NOTE: This file may be included into either C or assembler code.
 *
 * Bjoren Davis, February 8, 2016.
 */

#ifndef __B1212HWDEF_H
#define __B1212HWDEF_H
 ...
 * Denali Interrupts.
 * Reference:
 *  from b1212 SOS: ./doc/digital/specification/b1212_Registers_and_Commands.xls
 *    Revision:      89
 *    By:            ccziesle
 *    At time:       2016/02/08 12:37:11
 */
...
/* Values include: */
#   define HWDEF_FIB_PRODOPT_HOSTCOMM_B     0
#   define HWDEF_FIB_PRODOPT_HOSTCOMM_N     2
#   define HWDEF_FIB_PRODOPT_HOSTCOMM       0x00000003

/* Values of 0 and 3 are undefined */
#   define HWDEF_FIB_PRODOPT_HOSTCOMM_SPI   1
#   define HWDEF_FIB_PRODOPT_HOSTCOMM_USB   2


/*
 * USB VID/PID.  Considered invalid if word is either 0x00000000 or 0xfffffff.
 *  VID is in low 16-bits, PID is in high 16-bits.
 */
/* USB VID/PID (4 bytes = 32 bits; [0x5084_0008, 0x5084_000b] */
#define HWDEF_FIB_USBVIDPID         (HWDEF_MEMMAP_SROM_FLASH_INFO_BLOCK_BASE \
                                     + 0x0008)
#define HWDEF_FIB_USBVIDPID_SIZE    4
...
/* 
 * Sensor Control Module (SCM) Low-Noise Adjust.
 * if bits[31:30] are 2'b10 or 2'b01, then the setting is valid.
 * if the setting is valid,
 *  - bits[20:16] are assigned to LNA_AVREG1[4:0]
 *  - bits[4:0] are assigned to LAN_AVREG0[4:0]
 */
#define HWDEF_FIB_SCM_LNA_AVREG       (HWDEF_MEMMAP_SROM_FLASH_INFO_BLOCK_BASE \
                                       + 0x03b0)
#define HWDEF_FIB_SCM_LNA_AVREG_VALID 0xc0000000

/* bits 4:0 */
#define HWDEF_FIB_SCM_LNA_AVREG0    0x0000001f
#define HWDEF_FIB_SCM_LNA_AVREG0_B  0
#define HWDEF_FIB_SCM_LNA_AVREG0_N  5

/* bits 20:16 */
#define HWDEF_FIB_SCM_LNA_AVREG1    0x001f0000
#define HWDEF_FIB_SCM_LNA_AVREG1_B  16
#define HWDEF_FIB_SCM_LNA_AVREG1_N  5


/*
 * Tiny Touch-for-Navigation VCM adjust
 * if bits[31:30] are 2'b10 or 2'b01, then the setting is valid.
 * if the setting is valid, bits3:0 are assigned to NAV_MISC[3:0]
 */
#define HWDEF_FIB_NAV_MISC          (HWDEF_MEMMAP_SROM_FLASH_INFO_BLOCK_BASE \
                                     + 0x03b8)
#define HWDEF_FIB_NAV_MISC_VALID    0xc0000000
#define HWDEF_FIB_NAV_MISC_B        0
#define HWDEF_FIB_NAV_MISC_N        4
 ...
 * AFE configuration
 */
#define HWDEF_AFE_NUM_RX  80
#define HWDEF_AFE_NUM_TX  84
...
/* 15 bits, plus a 16th bit for sign */
#define HWDEF_AFE_SIGN              0x8000
#define HWDEF_AFE_SIGN_N            15
#define HWDEF_AFE_SIGN_B            1
#define HWDEF_AFE_MAGNITUDE         0x7fff
#define HWDEF_AFE_MAGNITUDE_N       15
#define HWDEF_AFE_MAGNITUDE_B       0

#endif      /* __B1212HWDEF_H */
