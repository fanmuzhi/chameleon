...
#  Adapted for Nassau/Hayes from 
#    ssh://gitms@git.synaptics.com/git/biometrics/b1210/tools.git
#    hexlist.pl commit 0bb3b51eccd48e697214bea09b0a68ea45d5eb6d
#   by Bjoren Davis, February 8, 2016.
#
...
dumprange(\$elffile, 'Flash (main)', 0x50800000, 0x18000);
dumprange(\$elffile, 'Flash (info block)', 0x50820000, 0x1000);
