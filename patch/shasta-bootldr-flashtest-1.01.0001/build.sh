...
cd fw/nassau/patch/bootldr/flashtest
make envid
time make shasta
date 

cp "obj\shasta-rom\flashtest.blpbin"  "..\..\..\..\..\..\shasta_flashtest.blpbin" 
cp "obj\shasta-rom\flashtest.blxepbin" "..\..\..\..\..\..\shasta_flashtest.blxepbin" 
