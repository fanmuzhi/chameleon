...
#define VCSFW_IOTA_ITYPE_IPL_PARAM     0x0018
#define VCSFW_IOTA_ITYPE_IPL_METRIC    0x0019

/* Specific to CPID: Temporal standard deviation of reference high frames */
#define VCSFW_IOTA_ITYPE_CPID_CAL_TEMPORAL_STANDARD_DEVIATION_OF_REFERENCE_HIGH_FRAMES   0x0018
...
/* Specific to CPID: Mean background + Bad_Pixel map: This is combination of mean background image
  ...
  */
#define VCSFW_IOTA_ITYPE_CPID_CAL_MEAN_BACKGROUND_MERGED_WITH_BAD_PIXELS   0x0019 /* CPID dark rate map saved at 1000 DPI */
...
/* Specific to CPID: Temporal standard deviation of reference high frames
  ...
  */
typedef struct VCS_PACKED vcsfw_cpid_cal_temporal_standard_deviation_of_reference_high_frames_s{
        vcsUint32_t   temporal_standard_deviation_of_reference_high_frames;
} vcsfw_cpid_cal_temporal_standard_deviation_of_reference_high_frames_t;
