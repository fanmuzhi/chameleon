...
/*
 * Nassau ASIC firmware: command definitions.
 *
 ...
 *  Viper, Viper2, and Palisade (B1203) ASICs.
...
/*
 * VCSFW_CMD_GET_PRINT_2D parameters must be n*4bytes in order to maintain
...
/* Note: this command will never be implemented for Nassau */
...
typedef struct fwcmd_param_dlimager_s
{
    ...
    uint16_t        fpbuf_rows;         /* number of rows in the raw fpbuf */
    uint16_t        reconimagesize;     /* number of dwords in recon image */
    uint16_t        persistentmemsize;  /* number of dwords in persistent memory pool */
    uint16_t        volatilememsize;    /* number of dwords in volatile memory pool */
...
/****************************************************************************/
/* VCSFW_CMD_ECHO (124 = 0x07c)                                             */
/****************************************************************************/

/****************************************************************************/
/* VCSFW_CMD_BOOTLDR_PATCH (125 = 0x07d)                                    */
/****************************************************************************/
...
/****************************************************************************/
/* VCSFW_CMD_FRAME_READ (127 = 0x07f)                                       */
/****************************************************************************/
...
/****************************************************************************/
/* VCSFW_CMD_FRAME_FINISH (129 = 0x081)                                     */
/****************************************************************************/



/****************************************************************************/
/* VCSFW_CMD_FRAME_STATE_GET (130 = 0x082)                                   */
/****************************************************************************/
...
/****************************************************************************/
/* VCSFW_CMD_IOTA_WRITE     (131 = 0x083)                                   */
/****************************************************************************/
...
FWCMD_ELCHECK(config_tag_pselect, frame_avg)
...
FWCMD_ELCHECK(config_nav_swipe, nav_mode)
...
FWCMD_ELCHECK(config_nav_swipe, h_min_vel)
...
FWCMD_ELCHECK(config_nav_swipe, v_min_vel)
...
typedef struct fwcmd_reply_prng_s
{
    uint8_t   value[256];
} fwcmd_reply_prng_t;

FWCMD_ELCHECK(reply_prng, value)
FWCMD_OVERALLSIZECHECK(reply_prng)
