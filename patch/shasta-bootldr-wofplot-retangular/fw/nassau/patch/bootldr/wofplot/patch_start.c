...
{   
    ...
    */
     ...
     */
    wr_word(SCM_LNA_CFG17, SCM_LNA_CFG17_WOF_TX_SEL);   // TX+ = 17
    wr_word(SCM_LNA_CFG19, SCM_LNA_CFG19_WOF_TX_SEL);   // TX+ = 19
    wr_word(SCM_LNA_CFG25, SCM_LNA_CFG25_WOF_TX_SEL);   // TX+ = 25
    wr_word(SCM_LNA_CFG27, SCM_LNA_CFG27_WOF_TX_SEL);   // TX+ = 27
    ...
    wr_word(SCM_LNA_CFG50, SCM_LNA_CFG58_WOF_RX_N_SEL 
            | (SCM_LNA_CFG50_LNA_GAIN & (SCM_LNA_CFG_LNA_GAIN_GAIN_17 << SCM_LNA_CFG50_LNA_GAIN_B))); // Rx- = 50 

    wr_word(SCM_LNA_CFG45, SCM_LNA_CFG45_WOF_TX_SEL | SCM_LNA_CFG45_WOF_TX_POL);   // TX- = 45 
    wr_word(SCM_LNA_CFG47, SCM_LNA_CFG47_WOF_TX_SEL | SCM_LNA_CFG47_WOF_TX_POL);   // TX- = 47 
    wr_word(SCM_LNA_CFG53, SCM_LNA_CFG53_WOF_TX_SEL | SCM_LNA_CFG53_WOF_TX_POL);   // TX- = 53 
