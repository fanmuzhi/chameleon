...
#endif      /* !defined(NASSAU_PATCH_BOOTLDR_IFVER)             * || NASSAU_PATCH_BOOTLDR_IFVER >= 1 */
...
#endif      /* !defined(NASSAU_PATCH_BOOTLDR_IFVER)             * || NASSAU_PATCH_BOOTLDR_IFVER >= 2 */
...
#endif      /* !defined(NASSAU_PATCH_BOOTLDR_IFVER)             * || NASSAU_PATCH_BOOTLDR_IFVER >= 3 */
