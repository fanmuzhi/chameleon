...
set BUILD_TARGET=win_m5_x64_dbg
...
set CMD=make -f cmakescripts\common\buildscripts\Makefile %BUILD_TARGET% TARG_PLAT=%TARGET_PLATFORM% BUILD_ENABLE_UNIT_TEST=%BUILD_ENABLE_UNIT_TEST% USE_IDE=1
echo "%CMD%"
%CMD%
