...
public:
    ...
    void setupUi(QWidget *LocalSettings)
    {
        ...
        gridLayout_5->addWidget(ConfigFileGroupBox, 0, 0, 1, 1);
        ...
        gridLayout_5->addWidget(LogFilePathGroupBox, 1, 0, 1, 1);
        ...
        gridLayout_5->addWidget(TestEngineGroupBox, 2, 0, 1, 1);
